...
results_all <- bind_rows(
  ...
  extract_structural_results(mods_anom, "WindowTmeanAnom")
)
...
p_anom <- plot_structural_effects(mods_anom, "WindowTmeanAnom", cor.dats)

ggsave("analysis/network/figures/NetworkStructure_APi.pdf",
       p_api,  width = 11, height = 8)

ggsave("analysis/network/figures/NetworkStructure_WindowTmeanAnom.pdf",
